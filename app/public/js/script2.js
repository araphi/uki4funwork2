...
function addNote(){
  ...
  $.post(baseUrl+"notes",params,function(data){
      document.getElementById("notes").innerHTML = "<tr><td id='id1' style='display:none;'>"+data._id+"</td><td id='title1'></td><td id='body1'></td></tr><tr><td id='id2'>"+data._id+"</td><td id='title2'></td><td id='body2'></td></tr>";
